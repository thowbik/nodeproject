...
// //Get all district
// router.get("/getdistricts/:stateId([0-9]+)", [checkJwt],   BaseController.listAllDistrict);

// //Get all users menu pages
// router.get("/getroles", [checkJwt], BaseController.listAllRoles);

// router.get("/universityList", [checkJwt],  BaseController.universityList);
